import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */import"./firebaseConfig-DCH0t8Yd.js";class a{constructor(){this.searchIndex=new Map,this.filters={},this.init()}init(){this.setupSearchUI(),this.buildSearchIndex(),this.setupFilters()}setupSearchUI(){const e=document.getElementById("searchContainer");e&&(e.innerHTML=`
    ...
    `}sortResults(e){console.log("Sorting results by:",e)}viewProfile(e,t){window.location.href=`/profile/${t}/${e}`}debounce(e,t){let i;return function(...n){const s=()=>{clearTimeout(i),e(...n)};clearTimeout(i),i=setTimeout(s,t)}}}const l=new a;window.searchEngine=l;
//# sourceMappingURL=search-Cv-05BqF.js.map
