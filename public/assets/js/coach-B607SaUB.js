...
import { E as T } from './teamComparison-DkPk5Wsi-DTB9EFa3.js';
...
const J = {
  ...
  V = r(J),
  X = l(V),
  q = localStorage.getItem('team') || 'Demo Team',
  F = y(m(X, 'games'), f('teamName', '==', q)),
  U = await d(F),
  E = [],
  M = [],
  x = [],
...
//# sourceMappingURL=coach-B607SaUB.js.map
