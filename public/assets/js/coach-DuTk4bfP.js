...
import { getStorage as Z } from 'https://www.gstatic.com/firebasejs/9.22.2/firebase-storage.js';
import { M as T } from './teamComparison-DkPk5Wsi-DTB9EFa3-P9lX6k0K-DNi_jEUI-P9lX6k0K-DNi_jEUI-P9lX6k0K-DNi_jEUI-P9lX6k0K-DNi_jEUI.js';
...
const J = {
  ...
  V = r(J),
  X = l(V),
  _ = localStorage.getItem('team') || 'Demo Team',
  U = y(m(X, 'games'), f('teamName', '==', _)),
  F = await d(U),
  E = [],
  M = [],
  x = [],
...
//# sourceMappingURL=coach-DuTk4bfP.js.map
