  ...
  ys = {
    ...
    encodeString(i, e) {
      return this.HAS_NATIVE_SUPPORT && !e
        ? btoa(i)
        : this.encodeByteArray(vs(i), e);
    },
    decodeString(i, e) {
      return this.HAS_NATIVE_SUPPORT && !e
        ? atob(i)
        : ya(this.decodeStringToByteArray(i, e));
    },
...
const ba = function (i) {
    const e = vs(i);
    return ys.encodeByteArray(e, !0);
  },
  ei = function (i) {
    return ba(i).replace(/\./g, '');
  },
  ws = function (i) {
    try {
      return ys.decodeString(i, !0);
    } catch (e) {
 ...
 */ const Ta = () => Ia().__FIREBASE_DEFAULTS__,
  _a = () => {
    if (typeof process > 'u' || typeof Ar > 'u') return;
    const i = Ar.__FIREBASE_DEFAULTS__;
  ...
  bs = i => {
    var e, n;
    return (n =
      (e = an()) === null || e === void 0 ? void 0 : e.emulatorHosts) ===
      null || n === void 0
      ? void 0
      : n[i];
  },
  ...
  Is = () => {
    var i;
    return (i = an()) === null || i === void 0 ? void 0 : i.config;
  },
  Ts = i => {
    var e;
    return (e = an()) === null || e === void 0 ? void 0 : e[`_${i}`];
  };
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */ function Aa(i, e) {
  ...
  return [ei(JSON.stringify(n)), ei(JSON.stringify(l)), ''].join('.');
}
/**
 * @license
 * Copyright 2017 Google LLC
...
class xa {
  ...
  subscribe(e, n, r) {
    ...
    (Fa(e, ['next', 'error', 'complete'])
      ...
      o.next === void 0 && (o.next = Hi),
      o.error === void 0 && (o.error = Hi),
      o.complete === void 0 && (o.complete = Hi));
 ...
 */ const Ha = 1e3,
  ...
  Ba = 4 * 60 * 60 * 1e3,
  Va = 0.5;
function Pr(i, e = Ha, n = $a) {
  const r = e * Math.pow(n, i),
    o = Math.round(Va * r * (Math.random() - 0.5) * 2);
  return Math.min(Ba, r + o);
}
/**
 * @license
 * Copyright 2021 Google LLC
...
const Qa = (i, e) => e.some(n => i instanceof n);
let Or, Rr;
function Za() {
  return (
    Or ||
    (Or = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
  );
}
function ec() {
  return (
...
function tc(i) {
  ...
  return (
    e
      .then(n => {
        n instanceof IDBCursor && ks.set(n, i);
      })
      .catch(() => {}),
    cn.set(e, i),
    e
...
function rc(i) {
  return i === IDBDatabase.prototype.transaction &&
    ...
    ? function (e, ...n) {
        const r = i.call(Bi(this), e, ...n);
        return (As.set(r, e.sort ? e.sort() : [e]), Oe(r));
      }
    : ec().includes(i)
      ? function (...e) {
          return (i.apply(Bi(this), e), Oe(ks.get(this)));
        }
      : function (...e) {
          return Oe(i.apply(Bi(this), e));
        };
}
function sc(i) {
  return typeof i == 'function'
    ? rc(i)
    : (i instanceof IDBTransaction && ic(i),
      Qa(i, Za()) ? new Proxy(i, Qi) : i);
}
function Oe(i) {
  if (i instanceof IDBRequest) return tc(i);
  if ($i.has(i)) return $i.get(i);
  const e = sc(i);
  return (e !== i && ($i.set(i, e), cn.set(e, i)), e);
}
const Bi = i => cn.get(i);
function Cs(i, e, { blocked: n, upgrade: r, blocking: o, terminated: c } = {}) {
 ...
 */ const en = '[DEFAULT]',
  jc = {
    ...
    [fc]: 'fire-app-check',
    [pc]: 'fire-app-check-compat',
    [gc]: 'fire-auth',
    [mc]: 'fire-auth-compat',
    [vc]: 'fire-rtdb',
    [yc]: 'fire-data-connect',
    [wc]: 'fire-rtdb-compat',
    [bc]: 'fire-fn',
    [Ic]: 'fire-fn-compat',
    [Tc]: 'fire-iid',
...
function he(i) {
  ...
  tn.set(e, i);
  for (const n of ti.values()) Lr(n, i);
  for (const n of xc.values()) Lr(n, i);
  return !0;
}
function ze(i, e) {
...
function Ps(i, e = {}) {
  ...
  const r = Object.assign({ name: en, automaticDataCollectionEnabled: !1 }, e),
    o = r.name;
  if (typeof o != 'string' || !o)
    throw Re.create('bad-app-name', { appName: String(o) });
  if ((n || (n = Is()), !n)) throw Re.create('no-options');
  const c = ti.get(o);
  if (c) {
  ...
  const l = new Ga(o);
  for (const y of tn.values()) l.addComponent(y);
  const f = new Hc(n, r, l);
  return (ti.set(o, f), f);
}
function hn(i = en) {
  const e = ti.get(i);
  if (!e && i === en && Is()) return Ps();
  if (!e) throw Re.create('no-app', { appName: i });
  return e;
}
function te(i, e, n) {
  var r;
  let o = (r = jc[i]) !== null && r !== void 0 ? r : i;
  n && (o += `-${n}`);
  const c = o.match(/\s|\//),
    l = e.match(/\s|\//);
  if (c || l) {
...
async function Vc(i) {
  try {
    const e = (await Os()).transaction(St),
      n = await e.objectStore(St).get(Rs(i));
...
async function Mr(i, e) {
  try {
    const n = (await Os()).transaction(St, 'readwrite');
    (await n.objectStore(St).put(e, Rs(i)), await n.done);
  } catch (n) {
  ...
  async getHeartbeatsHeader() {
    ...
    try {
      if (
        ...
        return '';
      const n = Ur(),
        { heartbeatsToSend: r, unsentEntries: o } = Gc(
          this._heartbeatsCache.heartbeats
        ),
        c = ei(JSON.stringify({ version: 2, heartbeats: r }));
      return (
...
function Gc(i, e = zc) {
  ...
  for (const o of i) {
    ...
    if (c) {
      if ((c.dates.push(o.date), jr(n) > e)) {
        c.dates.pop();
        break;
      }
    } else if ((n.push({ agent: o.agent, dates: [o.date] }), jr(n) > e)) {
      n.pop();
      break;
    }
    r = r.slice(1);
...
function jr(i) {
  return ei(JSON.stringify({ version: 2, heartbeats: i })).length;
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function js({ projectId: i }) {
  return `${Qc}/projects/${i}/installations`;
}
function xs(i) {
  return {
    token: i.token,
    requestStatus: 2,
    expiresIn: rh(i.expiresIn),
    creationTime: Date.now(),
  };
}
async function Fs(i, e) {
...
function nh(i, { refreshToken: e }) {
  const n = Hs(i);
  return (n.append('Authorization', sh(e)), n);
}
async function $s(i) {
  const e = await i();
 ...
 */ async function oh(
  ...
  const l = { fid: n, authVersion: Ms, appId: i.appId, sdkVersion: Ls },
  ...
  } else throw await Fs('Create Installation', y);
}
/**
 * @license
 * Copyright 2019 Google LLC
...
function hh() {
  try {
    ...
    ((self.crypto || self.msCrypto).getRandomValues(i),
      (i[0] = 112 + (i[0] % 16)));
    const e = lh(i);
    return ch.test(e) ? e : nn;
  } catch {
    return nn;
  }
}
function lh(i) {
  return ah(i).substr(0, 22);
}
/**
 * @license
 * Copyright 2019 Google LLC
...
function uh(i, e) {
  const n = dh();
  (n && n.postMessage({ key: i, fid: e }), ph());
}
let xe = null;
function dh() {
  return (
    !xe &&
      ...
      (xe.onmessage = i => {
        qs(i.data.key, i.data.fid);
      })),
    xe
  );
}
function ph() {
  Vs.size === 0 && xe && (xe.close(), (xe = null));
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const fh = 'firebase-installations-database',
  gh = 1,
...
async function ii(i, e) {
  const n = ui(i),
    r = (await un()).transaction($e, 'readwrite'),
    o = r.objectStore($e),
    c = await o.get(n);
  return (
    await o.put(e, n),
    await r.done,
    (!c || c.fid !== e.fid) && zs(i, e.fid),
    e
  );
}
async function Ks(i) {
  const e = ui(i),
    n = (await un()).transaction($e, 'readwrite');
 ...
 */ async function dn(i) {
  let e;
  const n = await di(i.appConfig, r => {
    const o = mh(r),
      c = vh(i, o);
...
function mh(i) {
  const e = i || { fid: hh(), registrationStatus: 0 };
  return Gs(e);
}
function vh(i, e) {
  if (e.registrationStatus === 0) {
    ...
    return e.registrationStatus === 1
      ? { installationEntry: e, registrationPromise: wh(i) }
      : { installationEntry: e };
}
async function yh(i, e) {
  try {
    const n = await oh(i, e);
    return ii(i.appConfig, n);
  } catch (n) {
    throw (
      Us(n) && n.customData.serverCode === 409
        ? await Ks(i.appConfig)
        : await ii(i.appConfig, { fid: e.fid, registrationStatus: 0 }),
      n
    );
  }
}
async function wh(i) {
  let e = await xr(i.appConfig);
  for (; e.registrationStatus === 1; )
    (await Bs(100), (e = await xr(i.appConfig)));
  if (e.registrationStatus === 0) {
    const { installationEntry: n, registrationPromise: r } = await dn(i);
    return r || n;
  }
  return e;
}
...
function Gs(i) {
  return bh(i) ? { fid: i.fid, registrationStatus: 0 } : i;
}
function bh(i) {
  return i.registrationStatus === 1 && i.registrationTime + Ns < Date.now();
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ async function Ih({ appConfig: i, heartbeatServiceProvider: e }, n) {
  const r = Th(i, n),
    o = nh(i, n),
    c = e.getImmediate({ optional: !0 });
  if (c) {
  ...
  const l = { installation: { sdkVersion: Ls, appId: i.appId } },
    f = { method: 'POST', headers: o, body: JSON.stringify(l) },
    y = await $s(() => fetch(r, f));
  if (y.ok) {
    const T = await y.json();
    return xs(T);
  } else throw await Fs('Generate Auth Token', y);
}
function Th(i, { fid: e }) {
  return `${js(i)}/${e}/authTokens:generate`;
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ async function pn(i, e = !1) {
  let n;
  const r = await di(i.appConfig, o => {
    if (!Ws(o)) throw He.create('not-registered');
    const c = o.authToken;
    if (!e && Sh(c)) return o;
    if (c.requestStatus === 1) return ((n = _h(i, e)), o);
    {
...
async function _h(i, e) {
  let n = await Fr(i.appConfig);
  for (; n.authToken.requestStatus === 1; )
    (await Bs(100), (n = await Fr(i.appConfig)));
  const r = n.authToken;
  return r.requestStatus === 0 ? pn(i, e) : r;
}
function Fr(i) {
  return di(i, e => {
...
async function Eh(i, e) {
  try {
    const n = await Ih(i, e),
      r = Object.assign(Object.assign({}, e), { authToken: n });
    return (await ii(i.appConfig, r), n);
  } catch (n) {
    if (
      Us(n) &&
...
function Sh(i) {
  return i.requestStatus === 2 && !kh(i);
}
function kh(i) {
  const e = Date.now();
  return e < i.creationTime || i.creationTime + i.expiresIn < e + Zc;
}
function Ah(i) {
...
function Ch(i) {
  return i.requestStatus === 1 && i.requestTime + Ns < Date.now();
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 */ async function Ph(i) {
  const e = i,
    { installationEntry: n, registrationPromise: r } = await dn(e);
  return (r ? r.catch(console.error) : pn(e).catch(console.error), n.fid);
}
/**
 * @license
 * Copyright 2019 Google LLC
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ async function Oh(i, e = !1) {
  const n = i;
  return (await Rh(n), (await pn(n, e)).token);
}
async function Rh(i) {
  const { registrationPromise: e } = await dn(i);
  e && (await e);
}
/**
 * @license
 ...
 * limitations under the License.
 */ function Dh(i) {
  if (!i || !i.options) throw Ki('App Configuration');
  if (!i.name) throw Ki('App Name');
  const e = ['projectId', 'apiKey', 'appId'];
  for (const n of e) if (!i.options[n]) throw Ki(n);
  return {
    appName: i.name,
 ...
 */ const Js = 'installations',
  ...
  Mh = i => {
    const e = i.getProvider('app').getImmediate(),
      n = ze(e, Js).getImmediate();
    return { getId: () => Ph(n), getToken: r => Oh(n, r) };
  };
function Uh() {
 ...
 */ const ni = 'analytics',
  ...
  fn = 'https://www.googletagmanager.com/gtag/js';
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
function zh(i, e) {
  const n = Vh('firebase-js-sdk-policy', { createScriptURL: Bh }),
...
async function Kh(i, e, n, r, o, c) {
  const l = r[o];
  try {
    if (l) await e[l];
    else {
      const f = (await Xs(n)).find(y => y.measurementId === o);
      f && (await e[f.appId]);
    }
  } catch (f) {
    Y.error(f);
...
function Xh(i) {
  ...
  for (const n of Object.values(e))
    if (n.src && n.src.includes(fn) && n.src.includes(i)) return n;
  return null;
}
/**
 * @license
...
async function tl(i) {
  ...
  const { appId: n, apiKey: r } = i,
    o = { method: 'GET', headers: el(r) },
    c = Hh.replace('{app-id}', n),
    l = await fetch(c, o);
...
async function il(i, e = Ys, n) {
  ...
  return (
    ...
    Qs({ appId: r, apiKey: o, measurementId: c }, l, f, e)
  );
}
async function Qs(i, { throttleEndTimeMillis: e, backoffCount: n }, r, o = Ys) {
  var c;
  ...
  try {
    ...
    const S =
        Number(
          ...
          ? Pr(n, o.intervalMillis, Yh)
          : Pr(n, o.intervalMillis),
...
async function cl(i, e, n, r, o, c, l) {
  var f;
  const y = il(i);
  (y
    .then(L => {
...
function ul() {
  const i = [];
  if (
    (_s() && i.push('This is a browser extension environment.'),
...
function dl(i, e, n) {
  ...
  if (!Vr) {
    qh(Gi);
    const { wrappedGtag: o, gtagCore: c } = Jh(bt, Hr, $r, Gi, ll);
    ((Zs = o), (Br = c), (Vr = !0));
  }
  return ((bt[r] = cl(i, Hr, $r, e, Br, Gi, n)), new hl(i));
}
function pl(i = hn()) {
  i = De(i);
  const e = ze(i, ni);
  return e.isInitialized() ? e.getImmediate() : fl(i);
}
function fl(i, e = {}) {
  const n = ze(i, ni);
  if (n.isInitialized()) {
...
function gl(i, e, n, r) {
  ((i = De(i)),
    ol(Zs, bt[i.app.options.appId], e, n, r).catch(o => Y.error(o)));
}
const zr = '@firebase/analytics',
  qr = '0.10.8';
function ml() {
  (he(
    new se(
  ...
  function i(e) {
    try {
      const n = e.getProvider(ni).getImmediate();
      return { logEvent: (r, o, c) => gl(n, r, o, c) };
    } catch (n) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const ri = new li('@firebase/auth');
function yl(i, ...e) {
  ri.logLevel <= O.WARN && ri.warn(`Auth (${it}): ${i}`, ...e);
}
function Xt(i, ...e) {
  ri.logLevel <= O.ERROR && ri.error(`Auth (${it}): ${i}`, ...e);
}
/**
 * @license
 * Copyright 2020 Google LLC
...
function io(i, e, n) {
  const r = Object.assign(Object.assign({}, vl()), { [e]: n });
...
async function nt(i, e, n, r, o = {}) {
  return ro(i, o, async () => {
    ...
    return (
      ...
      no.fetch()(so(i, i.config.apiHost, n, f), T)
    );
  });
}
async function ro(i, e, n) {
  i._canInitEmulator = !1;
  const r = Object.assign(Object.assign({}, Tl), e);
  try {
    const o = new Sl(i),
    ...
    if ('needConfirmation' in l)
      throw Wt(i, 'account-exists-with-different-credential', l);
    if (c.ok && !('errorMessage' in l)) return l;
    {
      const f = c.ok ? l.errorMessage : l.error.message,
        [y, T] = f.split(' : ');
      if (y === 'FEDERATED_USER_ID_ALREADY_LINKED')
        throw Wt(i, 'credential-already-in-use', l);
      if (y === 'EMAIL_EXISTS') throw Wt(i, 'email-already-in-use', l);
      if (y === 'USER_DISABLED') throw Wt(i, 'user-disabled', l);
...
function so(i, e, n, r) {
  const o = `${e}${n}?${r}`;
  return i.config.emulator ? vn(i.config, o) : `${i.config.apiScheme}://${o}`;
}
class Sl {
  constructor(e) {
    ((this.auth = e),
...
async function Al(i, e = !1) {
  ...
  return {
    claims: o,
    token: r,
    authTime: It(Wi(o.auth_time)),
    issuedAtTime: It(Wi(o.iat)),
    expirationTime: It(Wi(o.exp)),
 ...
 */ async function si(i) {
  ...
  const l =
    ...
    k = {
      ...
      providerData: f,
      metadata: new sn(c.createdAt, c.lastLoginAt),
      isAnonymous: S,
    };
  Object.assign(i, k);
}
...
async function Nl(i, e) {
  return nt(i, 'POST', '/v2/accounts:revokeToken', yn(i, e));
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class ge {
  constructor(e) {
    var { uid: n, auth: r, stsTokenManager: o } = e,
      c = gn(e, ['uid', 'auth', 'stsTokenManager']);
    ((this.providerId = 'firebase'),
      ...
      (this.metadata = new sn(c.createdAt || void 0, c.lastLoginAt || void 0)));
  }
  async getIdToken(e) {
  ...
  static async _fromGetAccountInfoResponse(e, n, r) {
    ...
    const y = new ge({
      ...
      T = {
        ...
        providerData: c,
        metadata: new sn(o.createdAt, o.lastLoginAt),
...
class Qe {
  ...
  static async create(e, n, r = 'authUser') {
    if (!n.length) return new Qe(me(Jr), e, r);
    const o = (
      await Promise.all(
        n.map(async T => {
    ...
    let c = o[0] || me(Jr);
    const l = Yt(r, e.config.apiKey, e.name);
    let f = null;
    for (const T of n)
      try {
...
function vo(i = K()) {
  return bn(i) || fo(i) || mo(i) || go(i) || /windows phone/i.test(i) || po(i);
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ async function jl(i, e = {}) {
  return nt(i, 'GET', '/v2/passwordPolicy', yn(i, e));
}
/**
 * @license
 * Copyright 2023 Google LLC
  ...
  constructor(e) {
    ...
    ((this.customStrengthOptions = {}),
      (this.customStrengthOptions.minPasswordLength =
        (n = l.minPasswordLength) !== null && n !== void 0 ? n : xl),
      l.maxPasswordLength &&
 ...
 */ class Hl {
  ...
  async initializeCurrentUserFromIdToken(e) {
    try {
      const n = await oo(this, { idToken: e }),
  ...
  async _getAppCheckToken() {
    ...
    const n = await ((e = this.appCheckServiceProvider.getImmediate({
      ...
      : e.getToken());
    return (
      n?.error && yl(`Error while retrieving App Check token: ${n.error}`),
      n?.token
    );
  }
}
...
class Yr {
  constructor(e) {
    ((this.auth = e),
      (this.observer = null),
      (this.addObserver = ja(n => (this.observer = n))));
  }
  get next() {
    return (
...
function Wl(i) {
  ...
  if (o) {
    const c = o[1];
    return { host: c, port: Qr(r.substr(c.length + 1)) };
  } else {
    const [c, l] = r.split(':');
    return { host: c, port: Qr(l) };
  }
}
function Qr(i) {
  if (!i) return null;
 ...
 */ async function Ze(i, e) {
  return El(i, 'POST', '/v1/accounts:signInWithIdp', yn(i, e));
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class Be extends bo {
  ...
  static fromJSON(e) {
    const n = typeof e == 'string' ? JSON.parse(e) : e,
      ...
      c = gn(n, ['providerId', 'signInMethod']);
    if (!r || !o) return null;
    const l = new Be(r, o);
    return (
...
function To(i, e, n, r) {
  return (
    ...
    throw o.code === 'auth/multi-factor-auth-required'
      ? oi._fromErrorAndOperation(i, o, e, r)
      : o;
  });
}
async function Yl(i, e, n = !1) {
 ...
 */ async function Ql(i, e, n = !1) {
  ...
  try {
    const c = await kt(i, To(r, o, e, i), n);
    E(c.idToken, r, 'internal-error');
    const l = wn(c.idToken);
...
function eu(i, e, n, r) {
  return De(i).onIdTokenChanged(e, n, r);
}
function tu(i, e, n) {
  return De(i).beforeAuthStateChanged(e, n);
}
const ai = '__sak';
/**
 * @license
 ...
 */ class _o {
  ...
  _isAvailable() {
    try {
      return this.storage
        ? (this.storage.setItem(ai, '1'),
          this.storage.removeItem(ai),
          Promise.resolve(!0))
        : Promise.resolve(!1);
    } catch {
...
function du() {
  const i = indexedDB.deleteDatabase(Co);
  return new Ot(i).toPromise();
}
function on() {
  const i = indexedDB.open(Co, uu);
  return new Promise((e, n) => {
    (i.addEventListener('error', () => {
      ...
      i.addEventListener('upgradeneeded', () => {
        const r = i.result;
        try {
          r.createObjectStore(ci, { keyPath: Po });
        } catch (o) {
          n(o);
        }
      }),
      i.addEventListener('success', async () => {
        const r = i.result;
        r.objectStoreNames.contains(ci)
          ? e(r)
          : (r.close(), await du(), e(await on()));
      }));
  });
}
async function es(i, e, n) {
  const r = fi(i, !0).put({ [Po]: e, value: n });
  return new Ot(r).toPromise();
}
async function pu(i, e) {
  const n = fi(i, !1).get(e),
    r = await new Ot(n).toPromise();
  return r === void 0 ? null : r.value;
}
function ts(i, e) {
  const n = fi(i, !0).delete(e);
...
class Oo {
  ...
  async _openDb() {
    return this.db ? this.db : ((this.db = await on()), this.db);
  }
  ...
  async initializeReceiver() {
    ((this.receiver = pi._getInstance(lu())),
  ...
  async _isAvailable() {
    try {
      ...
      const e = await on();
      return (await es(e, ai, '1'), await ts(e, ai), !0);
    } catch {}
    return !1;
  }
  ...
  async _set(e, n) {
    return this._withPendingWrite(
      async () => (
        await this._withRetries(r => es(r, e, n)),
        (this.localCache[e] = n),
  ...
  async _get(e) {
    const n = await this._withRetries(r => pu(r, e));
    return ((this.localCache[e] = n), n);
  }
  async _remove(e) {
    return this._withPendingWrite(
      async () => (
        await this._withRetries(n => ts(n, e)),
  ...
  startPolling() {
    (this.stopPolling(),
      (this.pollTimer = setInterval(async () => this._poll(), fu)));
  }
  stopPolling() {
    this.pollTimer && (clearInterval(this.pollTimer), (this.pollTimer = null));
  }
...
function yu(i) {
  return Zl(i.auth, new En(i), i.bypassAuthState);
}
function wu(i) {
  const { auth: e, user: n } = i;
  return (E(n, e, 'internal-error'), Ql(n, new En(i), i.bypassAuthState));
}
async function bu(i) {
  const { auth: e, user: n } = i;
  return (E(n, e, 'internal-error'), Yl(n, new En(i), i.bypassAuthState));
}
/**
 * @license
 * Copyright 2020 Google LLC
...
function Au(i) {
  return Yt(Tu, i.config.apiKey, i.name);
}
async function Cu(i, e, n = !1) {
  if (Pe(i.app)) return Promise.reject(Fe(i));
  const r = In(i),
    o = vu(r, e),
    c = await new _u(r, o, n).execute();
  return (
    c &&
      !n &&
...
function Uu(i) {
  ...
  if (!Lu.test(n)) return !1;
  if (Nu.test(i)) return r === i;
  const o = i.replace(/\./g, '\\.');
...
function xu(i) {
  return new Promise((e, n) => {
    ...
    function l() {
      (ns(),
        gapi.load('gapi.iframes', {
          ...
          ontimeout: () => {
            (ns(), n(ae(i, 'network-request-failed')));
          },
          timeout: ju.get(),
        }));
    }
    if (
      ...
      const f = zl('iframefcb');
      return (
        (ce()[f] = () => {
          gapi.load ? l() : n(ae(i, 'network-request-failed'));
        }),
        Bl(`${Vl()}?onload=${f}`).catch(y => n(y))
      );
    }
  }).catch(e => {
    throw ((Zt = null), e);
...
function qu(i) {
  ...
  const n = e.emulator ? vn(e, Bu) : `https://${i.config.authDomain}/${$u}`,
    r = { apiKey: e.apiKey, appName: i.name, v: it },
    o = zu.get(i.config.apiHost);
  o && (r.eid = o);
...
function Qu(i, e, n, r = Wu, o = Ju) {
  ...
  const y = Object.assign(Object.assign({}, Gu), {
    ...
    T = K().toLowerCase();
  (n && (f = uo(T) ? Xu : n), ho(T) && ((e = e || Yu), (y.scrollbars = 'yes')));
  const S = Object.entries(y).reduce((A, [L, P]) => `${A}${L}=${P},`, '');
  if (Ll(T) && f !== '_self') return (Zu(e || '', f), new rs(null));
 ...
 */ const ed = '__/auth/handler',
  ...
  id = encodeURIComponent('fac');
async function ss(i, e, n, r, o, c) {
  ...
  const y = await i._getAppCheckToken(),
    T = y ? `#${id}=${encodeURIComponent(y)}` : '';
  return `${nd(i)}?${At(f).slice(1)}${T}`;
}
function nd({ config: i }) {
  return i.emulator ? vn(i, td) : `https://${i.authDomain}/${ed}`;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
class rd {
  ...
  async _openPopup(e, n, r, o) {
    ...
    const l = await ss(e, n, r, rn(), o);
    return Qu(e, l, _n());
  }
  async _openRedirect(e, n, r, o) {
    await this._originValidation(e);
    const c = await ss(e, n, r, rn(), o);
  ...
  _isIframeWebStorageSupported(e, n) {
    this.iframes[e._key()].send(
      ...
      r => {
        var o;
        const c = (o = r?.[0]) === null || o === void 0 ? void 0 : o[Ji];
  ...
  _originValidation(e) {
    ...
    return (
      this.originValidationPromises[n] ||
        (this.originValidationPromises[n] = Mu(e)),
      this.originValidationPromises[n]
    );
  }
  ...
  (he(
    ...
    he(
      new se(
        'auth-internal',
        e => {
          const n = In(e.getProvider('auth').getImmediate());
          return (r => new od(r))(n);
        },
        'PRIVATE'
      ).setInstantiationMode('EXPLICIT')
...
function dd(i = hn()) {
  ...
  const n = ql(i, { popupRedirectResolver: sd, persistence: [mu, ru, ko] }),
    r = Ts('authTokenSyncURL');
  if (r && typeof isSecureContext == 'boolean' && isSecureContext) {
    const c = new URL(r, location.origin);
    if (location.origin === c.origin) {
      const l = ud(c.toString());
      (tu(n, l, () => l(n.currentUser)), eu(n, f => l(f)));
    }
  }
  const o = bs('auth');
  return (o && Gl(n, `http://${o}`), n);
}
function pd() {
  var i, e;
  return (e =
...
*/ function e(v, u) {
  ...
  function ie(v, u) {
    ...
    if (30 < v.g.length) {
      ...
      for (var p = A, g = u; 0 >= g.l(v); ) ((p = Ne(p)), (g = Ne(g)));
      var m = G(p, 1),
        b = G(g, 1);
...
*/ var l = l || {},
  ...
  Lt.prototype.add = function (t, s, a, h, w) {
    ...
    return (
      -1 < _
        ? ((s = t[_]), a || (s.fa = !1))
        : ((s = new Bo(s, this.src, I, !!h, w)), (s.fa = a), t.push(s)),
      s
    );
  };
  function mi(t, s) {
  ...
  var yi = 'closure_lm_' + ((1e6 * Math.random()) | 0),
    wi = {};
  function On(t, s, a, h, w) {
    if (Array.isArray(s)) {
      for (var I = 0; I < s.length; I++) On(t, s[I], a, h, w);
      return null;
    }
    return (
      (a = Nn(a)),
      t && t[Dt] ? t.K(s, a, T(h) ? !!h.capture : !1, w) : Vo(t, s, a, !1, h, w)
    );
  }
  function Vo(t, s, a, h, w, I) {
    if (!s) throw Error('Invalid event type');
    var _ = T(w) ? !!w.capture : !!w,
      N = Ii(t);
    if ((N || (t[yi] = N = new Lt(t)), (a = N.add(s, a, h, _, I)), a.proxy))
      return a;
    if (
      ((h = zo()),
      (a.proxy = h),
    ...
    if (typeof t != 'number' && t && !t.da) {
      ...
      if (s && s[Dt]) mi(s.i, t);
        ...
        (s.removeEventListener
          ...
          (a = Ii(s))
            ? (mi(a, t), a.h == 0 && ((a.src = null), (s[yi] = null)))
            : Nt(t));
      }
    }
  }
  function Dn(t) {
    return t in wi ? wi[t] : (wi[t] = 'on' + t);
  }
  function qo(t, s) {
    if (t.da) t = !0;
    else {
      ...
      var a = t.listener,
        h = t.ha || t.src;
      (t.fa && bi(t), (t = a.call(h, s)));
    }
    return t;
  }
  function Ii(t) {
    return ((t = t[yi]), t instanceof Lt ? t : null);
  }
  ...
  function Mt(t, s, a, h) {
    ...
    for (var w = !0, I = 0; I < s.length; ++I) {
      ...
      if (_ && !_.da && _.capture == a) {
        var N = _.listener,
          x = _.ha || _.src;
        (_.fa && mi(t.i, _), (w = N.call(x, h) !== !1 && w));
      }
    }
  ...
  class Ko extends be {
    ...
    j(s) {
      ((this.h = arguments), this.g ? (this.i = !0) : Mn(this));
    }
    N() {
      (super.N(),
        this.g &&
  ...
  ((ct.prototype.N = function () {
    (ct.aa.N.call(this), jn(this));
  }),
    (ct.prototype.handleEvent = function () {
      throw Error('EventHandler.handleEvent not implemented');
    }));
  var _i = f.JSON.stringify,
    Go = f.JSON.parse,
    Wo = class {
      stringify(t) {
...
` +
  ...
  var zn = {},
    Pi = {};
  function Oi(t, s, a) {
    ((t.L = 1), (t.v = Ht(de(s))), (t.m = a), (t.P = !0), qn(t, null));
  }
  function qn(t, s) {
    ...
    (Array.isArray(h) || (h = [String(h)]),
      ...
      (a = t.j.J),
      (t.h = new Vn()),
      (t.g = _r(t.j, a ? s : null, !t.m)),
      0 < t.O && (t.M = new Ko(A(t.Y, t, t.g), t.O)),
      (s = t.U),
      (a = t.g),
      (h = t.ca));
    var w = 'readystatechange';
    Array.isArray(w) || (w && (Un[0] = w.toString()), (w = Un));
    for (var I = 0; I < w.length; I++) {
      var _ = On(a, w[I], h || s.handleEvent, !1, s.h || s);
      if (!_) break;
      s.g[_.key] = _;
    }
    ((s = t.H ? u(t.H) : {}),
      ...
      try {
        if (t == this.g)
          e: {
            ...
            if (
              !(3 > W) &&
              (W != 3 || (this.g && (this.h.h || this.g.oa() || dr(this.g))))
            ) {
              (this.J ||
                W != 4 ||
                s == 7 ||
              ...
              if (
                ...
                (W == 4 && Le(this),
                  this.o &&
                    !this.J &&
                    (W == 4 ? wr(this.j, this) : ((this.o = !1), jt(this))));
              } else
                (ma(this.g),
...
`,
  ...
  function Di(t, s) {
    try {
      var a = t.j;
      if (a.G != 0 && (a.g == t || Ni(a.h, t))) {
        if (!t.K && Ni(a.h, t) && a.G == 3) {
          try {
                ...
                if (ne) {
                  ...
                  if (Gt) {
                    ...
                    I.g ||
                      ...
                      ((I.j = I.l),
                      (I.g = new Set()),
                      I.h && (Li(I, I.h), (I.h = null)));
                  }
                  if (h.D) {
                    const Fi = ne.g
                      ? ne.g.getResponseHeader('X-HTTP-Session-Id')
                      : null;
                    Fi && ((h.ya = Fi), D(h.I, h.D, Fi));
                  }
                }
                ((a.G = 3),
                  a.l && a.l.ua(),
                  ...
                  (h = a));
                var _ = t;
                if (((h.qa = Tr(h, h.J ? h.ia : null, h.W)), _.K)) {
                  Yn(h.h, _);
                  var N = _,
                    x = h.L;
                  (x && (N.I = x), N.B && (Ri(N), jt(N)), (h.g = _));
                } else vr(h);
                0 < a.i.length && qt(a);
  ...
  Wn.prototype.cancel = function () {
    if (((this.i = Qn(this)), this.h)) (this.h.cancel(), (this.h = null));
  ...
  function Zn(t, s) {
    if (t.forEach && typeof t.forEach == 'function') t.forEach(s, void 0);
      ...
      for (var a = ia(t), h = ta(t), w = h.length, I = 0; I < w; I++)
  ...
  Me.prototype.toString = function () {
    ...
    return (
      ...
      (a = this.l) &&
        ...
        t.push(ft(a, a.charAt(0) == '/' ? oa : sa, !0))),
      (a = this.i.toString()) && t.push('?', a),
      (a = this.m) && t.push('#', ft(a, ca)),
      t.join('')
    );
  };
  function de(t) {
  ...
  ((i.forEach = function (t, s) {
    ...
    (i.V = function (t) {
      ...
      let s = [];
      if (typeof t == 'string')
        rr(this, t) && (s = s.concat(this.g.get(Ge(this, t))));
      else {
    ...
    (i.set = function (t, s) {
      return (
        ...
        (this.i = null),
        (t = Ge(this, t)),
        rr(this, t) && (this.h -= this.g.get(t).length),
        this.g.set(t, [s]),
        (this.h += 1),
        this
      );
  ...
  function pa(t, s, a) {
    ...
    try {
      Zn(t, function (w, I) {
        let _ = w;
        (T(w) && (_ = _i(w)), s.push(h + I + '=' + encodeURIComponent(_)));
      });
    } catch (w) {
  ...
  ((i.Pa = function (t) {
    if (this.g) {
      ...
      (t.done ? mt(this) : vt(this), this.readyState == 3 && or(this));
    }
  }),
    (i.Ra = function (t) {
...
`));
    ...
    (i.ea = function (t, s, a, h) {
      ...
      (this.H && (this.g.responseType = this.H),
        'withCredentials' in this.g &&
          ...
          (this.g.withCredentials = this.J));
      try {
        (ur(this), (this.u = !0), this.g.send(t), (this.u = !1));
      } catch (I) {
        cr(this, I);
      }
    }));
  ...
  ((i.abort = function (t) {
    ...
    (i.Ea = function () {
      this.s || (this.B || this.u || this.j ? lr(this) : this.bb());
    }),
    (i.bb = function () {
      lr(this);
    }));
      ...
      if (t.u && pe(t) == 4) Ln(t.Ea, 0, t);
        ...
        try {
          ...
          if (!(a = s)) {
            var h;
            if ((h = _ === 0)) {
              var w = String(t.D).match(er)[1] || null;
              (!w &&
                f.self &&
                f.self.location &&
                (w = f.self.location.protocol.slice(0, -1)),
                (h = !fa.test(w ? w.toLowerCase() : '')));
            }
            a = h;
          }
...
`);
  ...
  function pr(t) {
    ((this.Aa = 0),
      ...
      (this.K = ''),
      (this.h = new Wn(t && t.concurrentRequestLimit)),
      (this.Da = new da()),
  ...
  function qt(t) {
    if (!Jn(t.h) && !t.s) {
      t.s = !0;
      var s = t.Ga;
      (st || Pn(), ot || (st(), (ot = !0)), gi.add(s, t), (t.B = 0));
    }
  }
  function va(t, s) {
    return Xn(t.h) >= t.h.j - (t.s ? 1 : 0)
      ? !1
      : t.s
        ? ((t.i = s.D.concat(t.i)), !0)
        : t.G == 1 || t.G == 2 || t.B >= (t.Va ? 0 : t.Wa)
          ? !1
          : ((t.s = lt(A(t.Ga, t, s), br(t, t.B))), t.B++, !0);
  }
  i.Ga = function (t) {
    if (this.s)
      if (((this.s = null), this.G == 1)) {
        if (!t) {
          ...
          ((s = mr(this, w, s)),
            ...
            I &&
              (this.O
                ? (s = 'headers=' + encodeURIComponent(String(ar(I))) + '&' + s)
                : this.m && Mi(a, this.m, I)),
            Li(this.h, w),
        ...
        this.G == 3 &&
          (t ? gr(this, t) : this.i.length == 0 || Jn(this.h) || gr(this));
  };
  function gr(t, s) {
    var a;
    s ? (a = s.l) : (a = t.U++);
  ...
  function vr(t) {
    if (!t.g && !t.u) {
      t.Y = 1;
      var s = t.Fa;
      (st || Pn(), ot || (st(), (ot = !0)), gi.add(s, t), (t.v = 0));
    }
  }
  function ji(t) {
    return t.g || t.u || 3 <= t.v
      ? !1
      : (t.Y++, (t.u = lt(A(t.Fa, t), br(t, t.v))), t.v++, !0);
  }
  ((i.Fa = function () {
    if (
      ((this.u = null),
  ...
  i.Za = function () {
    this.C != null && ((this.C = null), zt(this), ji(this), z(19));
  };
  function Kt(t) {
  ...
  function wr(t, s) {
    ...
    if (t.g == s) {
      (Kt(t), xi(t), (t.g = null));
      var h = 2;
    } else if (Ni(t.h, s)) ((a = s.D), Yn(t.h, s), (h = 1));
    else return;
    if (t.G != 0) {
      if (s.o)
        if (h == 1) {
  ...
  function Ue(t, s) {
    if ((t.j.info('Error code ' + s), s == 2)) {
      ...
      ((h = new Me(h || '//www.google.com/images/cleardot.gif')),
        (f.location && f.location.protocol == 'http') || xt(h, 'https'),
        Ht(h),
        w ? la(h.toString(), a) : ua(h.toString(), a));
    } else z(2);
    ((t.G = 0), t.l && t.l.sa(s), Ir(t), fr(t));
  }
  i.fb = function (t) {
    t
  ...
  (P(ee, $),
    ...
    (ee.prototype.o = function (t) {
      ...
      if (typeof t == 'string') {
        var a = {};
        ((a.__data__ = t), (t = a));
      } else this.u && ((a = {}), (a.__data__ = _i(t)), (t = a));
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const tt = new li('@firebase/firestore');
function re(i, ...e) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function kn(i = 'Unexpected state') {
              ...
              this.i !== e
                ...
                : r
                  ? (Tt(typeof r.accessToken == 'string'),
                    new Mo(r.accessToken, this.currentUser))
                  : null
            )
...
class wd {
  ...
  getToken() {
    return Promise.resolve(new yd(this.l, this.h, this.P));
  }
  start(e, n) {
...
var ds, ps;
(((ps = ds || (ds = {})).ea = 'default'), (ps.Cache = 'cache'));
/**
 * @license
 * Copyright 2023 Google LLC
 *
...
function kd(i) {
  ...
  return typeof i == 'function' ? 'a function' : kn();
}
function Ad(i, e) {
...
function Cd(i, e, n, r = {}) {
  var o;
  const c = (i = Ad(i, Uo))._getSettings(),
    l = `${e}:${n}`;
  if (
    ...
    i._authCredentials = new md(new Mo(f, y));
  }
}
/**
 * @license
...
` +
            ...
            throw (Lo('INTERNAL UNHANDLED ERROR: ', o), r);
          })
          .then(r => ((this.du = !1), r))
      )
    );
  ...
  enqueueAfterDelay(e, n, r) {
    ...
    const o = An.createAndSchedule(this, e, n, r, c => this.yu(c));
      ...
      new se(
        ...
        (n, { instanceIdentifier: r, options: o }) => {
          const c = n.getProvider('app').getImmediate(),
            l = new Pd(
              new vd(n.getProvider('auth-internal')),
              new Id(n.getProvider('app-check-internal')),
              (function (f, y) {
                if (
                ...
                return new hi(f.options.projectId, y);
              })(c, r),
              c
            );
          return (
...
pl(Cn);
export { Cn as C };
//# sourceMappingURL=firebaseConfig-DCH0t8Yd-CLd0mPF9-BmnogoZy-Cf6bMmA_-B8D1IVXI-Cf6bMmA_-B8D1IVXI-Cf6bMmA_-B8D1IVXI-Cf6bMmA_-B8D1IVXI-Cf6bMmA_-B8D1IVXI-Cf6bMmA_-B8D1IVXI-Cf6bMmA_.js.map
