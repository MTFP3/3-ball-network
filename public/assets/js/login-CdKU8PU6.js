...
import { P as s } from './firebaseConfig-DCH0t8Yd-CLd0mPF9.js';
import {
  getAuth as c,
...
document.getElementById('loginForm').addEventListener('submit', async e => {
  ...
  t.textContent = '';
  try {
    const a = (await r(m, n, o)).user.uid;
    (await d(l(i, 'players', a))).exists()
...
//# sourceMappingURL=login-CdKU8PU6.js.map
