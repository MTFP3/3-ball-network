...
var y = p((S, l) => {
  ...
  class g {
    ...
    processAssist(e, t, s) {
      ...
      ((e.assistedPlayer = this.findPlayer(t)),
        (e.points = i),
        this.currentPlayer === e.player?.id && (this.quickStats.assists += 1));
    }
    processRebound(e) {
    ...
    showQuickTapFeedback(e) {
      this.updateUIElement('quick-tap-feedback', { message: e, timeout: 1500 });
    }
  ...
  typeof window < 'u' && (window.SmartGameInput = g);
  class f {
    constructor() {
    ...
    analyzeTrends(e = 10) {
      ...
      const s = {},
        i = this.calculateTrend(
          t.map(n => (n.stats.fga > 0 ? (n.stats.fgm / n.stats.fga) * 100 : 0))
        );
      s.shooting = {
    ...
    calculateTrend(e) {
      ...
      const t = e.length,
        ...
        n = s.reduce((c, o, d) => c + o * e[d], 0),
        u = s.reduce((c, o) => c + o * o, 0);
      return (t * n - i * a) / (t * u - i * i);
    }
    getTrendMessage(e, t) {
    ...
    generateComparisons(e, t = 'high_school') {
      ...
      return (
        Object.keys(s).forEach(n => {
          const u = i[n] || 0,
            c = s[n],
            o = this.calculatePercentile(u, c);
          a[n] = {
            player: u,
            benchmark: c.average,
            percentile: o,
    ...
    getRecommendations() {
      ...
      const s = e.reduce((a, n) => a + (n.stats.turnovers || 0), 0) / e.length,
        i =
          e.reduce((a, n) => {
            const u = n.stats.fga || 0;
            return a + (u > 0 ? (n.stats.fgm / u) * 100 : 0);
          }, 0) / e.length;
      return (
        s > 3 &&
          t.push({
  ...
  typeof window < 'u' && (window.PlayerAnalytics = f);
  class h {
    constructor() {
      ((this.modules = {}),
        (this.sharedData = {
    ...
    calculateConnectionStrength(e, t) {
      const s = (e.assistsToPlayer2 || 0) / Math.max(e.totalAssists || 1, 1),
        i = (e.turnoversWithPlayer2 || 0) / Math.max(e.totalTurnovers || 1, 1),
        a = s * 100 - i * 50;
      ...
      return (
        ...
        e.assistToTurnoverRatio > 2
          ...
          : e.assistToTurnoverRatio < 1 &&
            ...
            t.recommendations.push('Practice decision-making under pressure')),
        t
      );
    }
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ((m = new h()),
      (window.BasketballPlatform = m),
      (window.PlatformManager = h));
  });
  typeof l < 'u' && l.exports && (l.exports = h);
});
export default y();
//# sourceMappingURL=platformManager-CMGNxMqx-BgtAjZPx-BgtAjZPx-BgtAjZPx-ChYnJq5S.js.map
