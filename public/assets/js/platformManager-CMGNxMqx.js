    ...
    [
      {
        ...
        check: s => s.points >= 10 && s.rebounds >= 10 && s.assists >= 10,
      },
      { id: 'sharpshooter', name: 'Sharpshooter', check: s => s.tpm >= 10 },
      {
        id: 'defensive-specialist',
        name: 'Defensive Specialist',
        check: s => s.steals >= 5 && s.blocks >= 3,
      },
      {
        id: 'lightning-fast',
        name: 'Lightning Fast',
        check: s => s.firstQuarterPoints >= 20,
      },
      {
        id: 'clutch-player',
        name: 'Clutch Player',
        check: s => s.gameWinningShot === !0,
      },
    ].forEach(s => {
      s.check(e.stats) && this.unlockAchievement(s);
    });
  }
  unlockAchievement(e) {
...
document.addEventListener('DOMContentLoaded', () => {
  ((o = new a()),
    (window.BasketballPlatform = o),
    (window.PlatformManager = a));
});
typeof module < 'u' && module.exports && (module.exports = a);
export { a as PlatformManager };
