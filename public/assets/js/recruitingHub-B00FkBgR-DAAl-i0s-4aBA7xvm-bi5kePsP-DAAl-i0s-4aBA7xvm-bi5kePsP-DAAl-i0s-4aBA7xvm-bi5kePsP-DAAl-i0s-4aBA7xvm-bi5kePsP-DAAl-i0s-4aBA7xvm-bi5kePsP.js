class h {
  ...
  findCollegeMatches(e) {
    ...
    return s
      ? this.collegeDatabase
          .map(t => {
            const i = this.matchAlgorithm.calculateCompatibility(s, t);
            return {
              college: t,
              compatibility: i,
              reasoning: this.matchAlgorithm.getReasoningDetails(s, t, i),
            };
          })
          .sort((t, i) => i.compatibility.overall - t.compatibility.overall)
          .slice(0, 10)
      : [];
  }
  calculateScholarshipProbability(e, s) {
    const t = this.playerProfiles.get(e),
      i = this.collegeDatabase.find(a => a.id === s);
  ...
  generateReelSummary(e, s) {
    ...
    return {
      ...
      videoCount: s.length,
      totalDuration: s.reduce((i, a) => i + (a.duration || 30), 0),
    };
  }
...
class c {
  ...
  calculateAthleticFit(e, s) {
    ...
    const n = s.stats?.averageStats?.[i];
    return (
      n &&
        (a.points >= n.points * 0.8 && (t += 25),
        a.assists >= n.assists * 0.8 && (t += 25),
        a.rebounds >= n.rebounds * 0.8 && (t += 20)),
      Math.min(100, t)
    );
  }
...
//# sourceMappingURL=recruitingHub-B00FkBgR-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP.js.map
