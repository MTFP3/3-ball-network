class h {
  ...
  generateReelSummary(t, i) {
    ...
    return {
      ...
      keyStrengths: this.identifyKeyStrengths(t, i),
      videoCount: i.length,
      totalDuration: i.reduce((s, a) => s + (a.duration || 30), 0),
    };
  }
  identifyKeyStrengths(t, i) {
    const e = [],
...
//# sourceMappingURL=recruitingHub-B00FkBgR-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s.js.map
