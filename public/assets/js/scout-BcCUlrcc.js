...
import { M as w } from './teamComparison-DkPk5Wsi-DTB9EFa3-P9lX6k0K-DNi_jEUI-P9lX6k0K-DNi_jEUI-P9lX6k0K-DNi_jEUI-P9lX6k0K-DNi_jEUI.js';
...
function h(o) {
  ((l.innerHTML = ''),
    ...
    `),
        l.appendChild(e));
      const r = S(k, `reports/${t.id}/daily.pdf`);
      v(r)
        .then(n => {
...
const D = {
  ...
  R = m(D),
  B = g(R),
  M = localStorage.getItem('playerId') || 'demoPlayer',
  T = d(B, 'players', M),
  p = await u(T),
  j = p.exists() ? p.data() : {},
  P = document.getElementById('smartTags');
P.innerHTML = (j.tags || []).map(o => `<li>${o}</li>`).join('');
//# sourceMappingURL=scout-BcCUlrcc.js.map
