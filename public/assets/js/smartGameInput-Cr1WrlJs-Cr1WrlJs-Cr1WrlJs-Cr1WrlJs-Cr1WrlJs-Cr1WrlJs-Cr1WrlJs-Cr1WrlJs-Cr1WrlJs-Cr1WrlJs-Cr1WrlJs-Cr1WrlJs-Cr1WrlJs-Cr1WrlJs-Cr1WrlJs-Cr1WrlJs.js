class r {
  ...
  handleVoiceResult(e) {
    const t = e.results,
      s = t[t.length - 1];
    if (s.isFinal) {
      const a = s[0].transcript.toLowerCase().trim();
      this.processVoiceCommand(a);
    }
  }
  processVoiceCommand(e) {
    ...
    for (const [a, i] of Object.entries(t)) {
      const o = e.match(i);
      if (o) {
        (this.executeVoiceCommand(a, o), (s = !0));
        break;
      }
    }
  ...
  executeVoiceCommand(e, t) {
    ...
    switch (e) {
      case 'score':
        this.processScore(i, t[3]);
        break;
      case 'miss':
        this.processMiss(i, t[3]);
        break;
      case 'assist':
        this.processAssist(i, t[2], t[3]);
        break;
      case 'rebound':
        this.processRebound(i);
        break;
      case 'steal':
        this.processSteal(i);
        break;
      case 'block':
        ...
        break;
      case 'turnover':
        this.processTurnover(i);
        break;
      case 'foul':
        this.processFoul(i);
        break;
    }
    (this.gameEvents.push(i),
      this.updateGameDisplay(),
      this.showVoiceConfirmation(i));
  }
  processScore(e, t) {
  ...
  processAssist(e, t, s) {
    const a = this.getPointsFromShotType(s);
...
typeof window < 'u' && (window.SmartGameInput = r);
export { r as SmartGameInput };
//# sourceMappingURL=smartGameInput-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs.js.map
