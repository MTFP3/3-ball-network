            ...
            return new Promise((m, I) => {
              (d.addEventListener('load', m),
                d.addEventListener('error', () =>
                  I(new Error(`Unable to preload CSS for ${r}`))
                ));
            });
        })
      );
...
function le() {
  ...
  l === f
    ? ((s.className = 'test-section pass'),
      (s.textContent = `🎉 All tests passed! (${l}/${f})`))
    : ((s.style.background = '#fff3cd'),
      (s.textContent = `⏳ Tests running... (${l}/${f} completed)`));
}
try {
  const s = await A(
    () =>
                                      ...
                                      y(
                                        () =>
                                          v(
                                            () =>
                                              import(
                                                './playerAnalytics-BQgY2Ufz-CHvk6QGw-C3HtcQ7W-CHvk6QGw-C3HtcQ7W-CHvk6QGw-C3HtcQ7W-CHvk6QGw-C3HtcQ7W-CHvk6QGw-C3HtcQ7W.js'
                                              ),
                                            []
                                          ),
                                        []
                                      ...
                                      y(
                                        () =>
                                          v(
                                            () =>
                                              import(
                                                './recruitingHub-B00FkBgR-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s.js'
                                              ),
                                            []
                                          ),
                                        []
                                      ...
                                      y(
                                        () =>
                                          v(
                                            () =>
                                              import(
                                                './smartGameInput-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs.js'
                                              ),
                                            []
                                          ),
                                        []
                                      ...
                                      y(
                                        () =>
                                          v(
                                            () =>
                                              import(
                                                './platformManager-CMGNxMqx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx.js'
                                              ),
                                            []
                                          ),
                                        []
...
//# sourceMappingURL=test-integration-DO2U55hK.js.map
