            ...
            return new Promise((p, j) => {
              (d.addEventListener('load', p),
                d.addEventListener('error', () =>
                  j(new Error(`Unable to preload CSS for ${o}`))
                ));
            });
        })
      );
...
function x() {
  const r = document.getElementById('overall-status'),
    l = Object.values(h).filter(i => i === !0).length,
    m = Object.keys(h).length;
  l === m
    ? ((r.className = 'test-section pass'),
      (r.textContent = `🎉 All tests passed! (${l}/${m})`))
    : ((r.style.background = '#fff3cd'),
      (r.textContent = `⏳ Tests running... (${l}/${m} completed)`));
}
try {
  const r = await b(
    () =>
                      ...
                      v(
                        () =>
                          y(
                            () =>
                              import(
                                './playerAnalytics-BQgY2Ufz-CHvk6QGw-C3HtcQ7W-CHvk6QGw-C3HtcQ7W-CHvk6QGw-C3HtcQ7W.js'
                              ),
                            []
                          ),
                        []
  ...
  f('playerAnalytics', !1, 'Failed to load: ' + r.message);
}
try {
  const r = await b(
    () =>
                      ...
                      v(
                        () =>
                          y(
                            () =>
                              import(
                                './recruitingHub-B00FkBgR-DAAl-i0s-4aBA7xvm-bi5kePsP-DAAl-i0s-4aBA7xvm-bi5kePsP.js'
                              ),
                            []
                          ),
                        []
  ...
  f('recruitingHub', !1, 'Failed to load: ' + r.message);
}
try {
  const r = await b(
    () =>
                      ...
                      v(
                        () =>
                          y(
                            () =>
                              import(
                                './smartGameInput-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs-Cr1WrlJs.js'
                              ),
                            []
                          ),
                        []
  ...
  f('smartGameInput', !1, 'Failed to load: ' + r.message);
}
try {
  const r = await b(
    () =>
                      ...
                      v(
                        () =>
                          y(
                            () =>
                              import(
                                './platformManager-CMGNxMqx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx-BgtAjZPx.js'
                              ),
                            []
                          ),
                        []
  ...
  f('platformManager', !1, 'Failed to load: ' + r.message);
}
setTimeout(() => {
...
//# sourceMappingURL=test-integration-D_txx2_e.js.map
